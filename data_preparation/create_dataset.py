...
Pay attention to keeping the data clean!
"""
...
def extract_doc_info(file_data):
    """
    Extract all the basic information about the product from a doc
...
def extract_section_names(package_leaflet, product_id):
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                # give up (skipped around 20 docs)
                return None, None
    ...
    # section1_title looks like 'what invega is and what it is used for'
...
def extract_section1(section_names, leaflet, product_name):
    ...
    *Assumption*: splitting by sectionN_title has always result in 2 parts - everything before sectionN_title,
    ...
    or thre are spelling mistakes, typos in sectionN_title
...
if __name__ == '__main__':
    ...
    for filename in os.listdir('product_information_EMA_documents/'):

        # path to the particular file
        path2file = 'product_information_EMA_documents/' + filename
        ...
        package_leaflet = extract_package_leaflet(product_content, product_id)
        ...
        section_names, leaflet = \
            extract_section_names(package_leaflet, product_id)
